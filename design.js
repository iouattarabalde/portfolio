...
const IOB_DESIGN_DEFAULTS = {
  colors: { accent: '#8A9A5B', bg: '#0C0C0C', fg: '#ECECE6' },
  typography: { bodySize: { desktop: 15, mobile: 15 } },
  grid: {
...
function iobDesignVars(d) {
  ...
  const bs = t.bodySize || {}, cols = g.columns || {}, gap = g.gap || {}, ratio = g.cardRatio || {}, pw = ct.photoWidth || {};
  return {
